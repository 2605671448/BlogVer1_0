...
<div id="LoginBox">
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td height="40" colspan="2" align="center"><input name="Submits" type="submit" class="Button" id="Submits" value="登录" />              &nbsp;&nbsp;<input name="ReSet" type="reset" class="Button" id="ReSet" value="重置" /></td>
        </tr>
    </table>
</div>
</form>
